...
for ii = 1: length(indexarray)
    ...
    for rr = 1 : repeat
        ...
        tesqme2 = tic;
        [x_esqme2, iter_esqme2] = L1L2_ESQM_ls(A, b, delta, mu, M, x0, d, alpha_init, maxiter, freq, tol);
        ...
        fprintf(' ESQM_ls  Termination: time_ESQM_ls = %g, iter = %d, nnz = %g, fval = %16.10f, diff = %g, feas vio = %g,\n',...
