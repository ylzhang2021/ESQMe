...
Suppose that in \eqref{KLproblem}, $P_1 = \|\cdot\|_1$, $C$ is a polyhedron, $m = 1$, and $g_1 = q_1\circ A_1$ for some matrix $A_1\in \R^{s_1\times n}$ and $q_1:\mathbb{R}^{s_1} \rightarrow \mathbb{R}$ taking one of the following forms with $b\in \R^{s_1}$ and $\sigma > 0$ chosen so that the origin is not feasible and that $\inf_{x\in C}g_1(x) < 0$:
\begin{enumerate}[{\rm (i)}]
...
&  0.766 &  2.532 &  5.488 &  9.710 & 15.326            \\\cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  1.096 &  4.684 & 11.230 & 19.402 & 31.853             \\\cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  0.686 &  2.437 &  5.558 &  9.925 & 17.198          \\ \cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
...
&    115 &    113 &    111 &    115 &    118          \\ \cline{1-7} \multirow{3}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  0.082 &  0.086 &  0.086 &  0.087 &  0.088       \\ \cline{1-7} \multirow{3}*{Residual} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  1.037 &  3.851 &  8.205 & 13.918 & 23.230           \\ \cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
...
&    162 &    159 &    163 &    162 &    171           \\ \cline{1-7} \multirow{3}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
