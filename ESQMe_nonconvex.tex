...
We perform tests on random instances of \eqref{CompSen1-1}. As in the previous section, we generate an $A\in\R^{q\times n}$ with i.i.d. standard Gaussian entries, and then normalize its columns. We then choose a subset $T$ of size $k$ uniformly at random from $\{1, 2, \cdots, n\}$ and generate a $k$-sparse vector $x_{\rm orig}$ with i.i.d. standard Gaussian entries on $T$. We let $b = Ax_{\rm orig} + 0.01\cdot\bar{n}$ with $\bar{n}_i\sim{\rm Cauchy}(0, 1)$, specifically, we generate $\bar{n}_i$ as $\tan(\pi(\tilde{n}_i - \frac{1}{2}))$ with $\tilde{n}$ being a random vector with i.i.d. entries uniformly chosen in $[0, 1]$. We then set $\sigma = 1.05\cdot\|0.01\cdot\tilde{n}\|_{L L_2, \gamma}$ with $\gamma = 0.08$.
...
& \multicolumn{1}{c|}{ $i = 6$ } & \multicolumn{1}{|c|}{ $i = 8$ } & \multicolumn{1}{c|}{ $i = 10$ }
\\ \cline{1-7}\multirow{6}*{CPU time (sec)} & \multirow{1}*{$t_{\rm QR}$}
&  0.824 &  5.036 & 17.566 & 39.612 & 69.247           \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.007 &  0.030 &  0.067 &  0.111 &  0.182           \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.834 &  1.735 &  5.774 & 12.335 & 26.668           \\ \cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  1.551 &  7.594 &  9.795 & 53.161 & 36.421           \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{\rm b}$}
&  3.704 & 13.797 & 31.920 & 55.549 & 88.741           \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.777 &  2.772 &  6.532 & 11.777 & 17.705           \\ \cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
...
&    116 &    122 &    123 &    127 &    127           \\ \cline{1-7} \multirow{3}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
...
& 8.80e-08 & 8.86e-08 & 8.62e-08 & 8.64e-08 & 8.51e-08   \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
& 2.96e-08 & 2.46e-08 & 2.47e-08 & 4.01e-09 & 4.45e-09   \\ \cline{1-7}
\end{tabular}
}
\end{center}
}
...
& \multicolumn{1}{c|}{ $i = 6$ } & \multicolumn{1}{|c|}{ $i = 8$ } & \multicolumn{1}{c|}{ $i = 10$ }
\\ \cline{1-7}\multirow{6}*{CPU time (sec)} & \multirow{1}*{$t_{\rm QR}$}
&  0.655 &  4.843 & 18.814 & 50.299 & 97.165            \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.006 &  0.028 &  0.068 &  0.133 &  0.185            \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.638 &  1.704 &  6.133 & 14.865 & 26.856            \\ \cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  1.626 &  9.008 & 12.058 & 60.072 & 42.175            \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{\rm b}$}
&  5.083 & 20.681 & 50.083 & 88.405 & 144.799            \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.987 &  3.754 &  9.181 & 16.361 & 27.351            \\ \cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    136 &    214 &    127 &    372 &    171            \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{\rm b}$}
&    883 &    914 &    914 &    914 &    919            \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&    158 &    164 &    165 &    163 &    170            \\ \cline{1-7} \multirow{3}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
...
& 8.64e-12 & 8.69e-12 & 8.37e-12 & 8.43e-12 & 8.30e-12    \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
& 3.45e-12 & 4.23e-12 & 3.38e-12 & 5.52e-12 & 2.88e-12    \\ \cline{1-7}
\end{tabular}
}
\end{center}
}
