...
In our numerical tests, we let $\mu =0.95$ in \eqref{CompSen1-1} and $(q,n,k) = (720i,2560i,160i)$ with $i\in \{2, 4, 6, 8, 10\}$. For each $i$, we generate 20 random instances as described above. We present the computational results when $\epsilon$ in \eqref{termination} equals $10^{-4}$ and $10^{-6}$ in Table~\ref{table1} and Table~\ref{table2}, respectively, averaged over the $20$ random instances. Here, we present the time for computing the QR decomposition of $A^T$ (denoted by $t_{\rm QR}$), the time for computing $\|A\|$ (denoted by $t_{\|A\|}$),  the time for computing $x^0 = A^\dagger b$ given the QR factorization of $A^T$ (denoted by $t_{A^\dagger b}$),\footnote{Note that $A^\dagger b$ is only used by SCP$_{\rm ls}$, and $\|A\|$ is only used by ESQM and ESQM$_{\rm e}$.} the CPU times of the algorithms (CPU time), the number of iterations (denoted by Iter), the recovery errors $\text{RecErr} := \frac{\|x^* - \xorig\|}{\max\{1, \|\xorig\|\}}$ and the residuals ${\rm Residual} := \frac{\|Ax^* - b\| - \sigma_1 }{\sigma_1}$, where $x^*$ is the approximate solution returned by the respective algorithm.
...
&  0.657 &  3.617 & 11.290 & 30.732 & 67.974           \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.006 &  0.025 &  0.056 &  0.101 &  0.157           \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.574 &  1.363 &  4.192 & 10.176 & 19.742           \\\cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  2.601 &  8.950 & 19.348 & 31.669 & 47.208           \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM}
& 10.511 & 40.935 & 93.814 & 150.119 & 235.307           \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  1.008 &  4.001 &  9.355 & 14.704 & 22.629           \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.669 &  2.564 &  5.847 &  9.498 & 14.805           \\\cline{1-7} \multirow{4}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    208 &    213 &    211 &    212 &    212           \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM}
&   1729 &   1781 &   1819 &   1768 &   1789           \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls}}$}
&    155 &    168 &    177 &    170 &    173           \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&    108 &    112 &    114 &    112 &    113           \\\cline{1-7} \multirow{4}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
&  0.053 &  0.053 &  0.054 &  0.055 &  0.055       \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM}
&  0.070 &  0.071 &  0.073 &  0.073 &  0.074       \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  0.052 &  0.052 &  0.053 &  0.054 &  0.054       \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.051 &  0.051 &  0.052 &  0.053 &  0.053       \\\cline{1-7} \multirow{4}*{Residual} & \multirow{1}*{SCP$_{\rm ls}$}
& -3.60e-05 & -4.50e-05 & -2.33e-05 & -3.16e-05 & -3.33e-05      \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM}
& 6.36e-07 & 6.03e-07 & 5.42e-07 & 5.60e-07 & 5.38e-07     \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
& 3.82e-05 & 3.93e-05 & 4.02e-05 & 3.86e-05 & 4.04e-05     \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
& 1.20e-07 & 1.10e-07 & 9.94e-08 & 9.69e-08 & 1.03e-07    \\\cline{1-7}
\end{tabular}
}
\end{center}
}
...
& \multicolumn{1}{c|}{ $i = 6$ } & \multicolumn{1}{|c|}{ $i = 8$ } & \multicolumn{1}{c|}{ $i = 10$ }
\\\cline{1-7}\multirow{7}*{CPU time} & \multirow{1}*{$t_{\rm QR}$}
&  0.669 &  4.040 & 11.727 & 28.752 & 53.565            \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.007 &  0.027 &  0.049 &  0.093 &  0.152            \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.667 &  1.517 &  4.400 &  9.914 & 18.806            \\\cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  3.095 & 10.169 & 22.397 & 37.676 & 57.152            \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM}
& 16.750 & 61.600 & 141.963 & 238.332 & 378.050            \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  1.659 &  6.264 & 13.721 & 23.655 & 37.549            \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  1.191 &  4.790 & 10.608 & 18.945 & 30.775            \\\cline{1-7} \multirow{4}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    251 &    257 &    257 &    258 &    259            \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM}
&   2756 &   2860 &   2954 &   2887 &   2924            \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls}}$}
&    258 &    277 &    291 &    283 &    288            \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&    195 &    220 &    228 &    230 &    237            \\\cline{1-7} \multirow{4}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
&  0.051 &  0.051 &  0.052 &  0.053 &  0.053           \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM}
&  0.051 &  0.051 &  0.052 &  0.053 &  0.053           \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  0.051 &  0.051 &  0.052 &  0.053 &  0.053           \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.051 &  0.051 &  0.052 &  0.052 &  0.053           \\\cline{1-7} \multirow{4}*{Residual} & \multirow{1}*{SCP$_{\rm ls}$}
& -5.29e-09 & -6.76e-09 & -7.02e-09 & -6.18e-09 & -1.08e-08      \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM}
& -7.34e-10 & -3.51e-10 & -1.88e-10 & -1.37e-10 & -6.49e-11     \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
& 3.27e-09 & 3.96e-09 & 4.09e-09 & 3.69e-09 & 3.73e-09   \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
& -1.31e-10 & 5.18e-11 & 1.55e-11 & 6.06e-11 & -4.13e-11   \\\cline{1-7}
\end{tabular}
}
\end{center}
}
...
From Table~\ref{table1} and Table~\ref{table2}, one can see that ESQM$_{{\rm e}}$ is the fastest algorithm, and the recovery errors of all four methods are comparable.
...
& \multicolumn{1}{c|}{ $i = 6$ } & \multicolumn{1}{|c|}{ $i = 8$ } & \multicolumn{1}{c|}{ $i = 10$ }
\\ \cline{1-7}\multirow{7}*{CPU time} & \multirow{1}*{$t_{\rm QR}$}
&  0.630 &  4.308 & 14.756 & 32.588 & 56.374         \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.006 &  0.028 &  0.060 &  0.101 &  0.146         \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.598 &  1.581 &  5.080 & 11.099 & 18.362         \\ \cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  1.929 & 10.603 & 12.760 & 76.295 & 46.565         \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM}
&  4.409 & 15.501 & 33.726 & 58.694 & 89.410         \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  1.482 &  4.074 &  8.267 & 14.526 & 22.468         \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.842 &  2.820 &  5.975 & 10.340 & 16.417         \\ \cline{1-7} \multirow{4}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    171 &    295 &    156 &    560 &    228         \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM}
&    648 &    644 &    643 &    657 &    665         \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls}}$}
&    178 &    149 &    146 &    156 &    157         \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&    116 &    113 &    112 &    116 &    118         \\ \cline{1-7} \multirow{4}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
&  0.082 &  0.086 &  0.086 &  0.087 &  0.089       \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM}
&  0.087 &  0.091 &  0.091 &  0.092 &  0.094       \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  0.083 &  0.087 &  0.087 &  0.087 &  0.089       \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
...
& 1.12e-07 & 9.82e-08 & 9.65e-08 & 9.42e-08 & 9.30e-08     \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
& 2.61e-07 & 1.51e-07 & 1.33e-07 & 1.26e-07 & 1.20e-07     \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
& 3.74e-08 & 5.09e-08 & 5.28e-08 & 5.77e-08 & 5.66e-08     \\ \cline{1-7}
\end{tabular}
}
\end{center}
}
...
& \multicolumn{1}{c|}{ $i = 6$ } & \multicolumn{1}{|c|}{ $i = 8$ } & \multicolumn{1}{c|}{ $i = 10$ }
\\ \cline{1-7}\multirow{7}*{CPU time} & \multirow{1}*{$t_{\rm QR}$}
&  0.585 &  3.748 & 13.055 & 31.274 & 55.625          \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.006 &  0.023 &  0.055 &  0.095 &  0.150          \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.589 &  1.400 &  4.672 & 10.151 & 18.521          \\ \cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  2.049 & 11.145 & 14.231 & 76.433 & 50.509          \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM}
&  6.981 & 24.560 & 53.360 & 92.190 & 146.439          \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls}}$}
&  2.273 &  5.770 & 12.088 & 21.519 & 32.552          \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  1.179 &  3.867 &  8.614 & 14.943 & 23.786          \\ \cline{1-7} \multirow{4}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    189 &    314 &    177 &    578 &    247          \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM}
&   1010 &   1030 &   1032 &   1053 &   1067          \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls}}$}
&    281 &    223 &    219 &    232 &    233          \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&    163 &    162 &    163 &    166 &    175          \\ \cline{1-7} \multirow{4}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
...
& -4.16e-12 & 2.49e-12 & 4.92e-12 & 5.74e-12 & 6.40e-12     \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls}}$}
& 1.01e-11 & 7.07e-12 & 7.65e-12 & 8.52e-12 & 8.62e-12     \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
& 6.41e-14 & 4.04e-12 & 3.35e-12 & 2.65e-12 & 2.98e-12     \\ \cline{1-7}
\end{tabular}
}
\end{center}
}
