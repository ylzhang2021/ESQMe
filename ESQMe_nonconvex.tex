...
Using the strong convexity of the objective in \eqref{subproblem2} and the fact that $x^{k+1}$ minimizes this objective, we obtain that for any $x\in C$,
