...
\begin{table}[h]
{\color{black}
\caption{Computational results for problem \eqref{CompSen1-1} with $\epsilon =10^{-8}$}\label{table3}
\begin{center}
{\footnotesize
...
&  0.573 &  3.538 & 12.148 & 28.069 & 50.198         \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.006 &  0.025 &  0.054 &  0.101 &  0.151         \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.558 &  1.403 &  4.466 &  9.620 & 17.734         \\\cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  1.099 &  3.795 &  8.191 & 14.061 & 21.498         \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM}
&  4.529 & 17.192 & 38.128 & 65.010 & 102.262         \\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.491 &  1.866 &  4.109 &  7.014 & 10.891         \\\cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    103 &    105 &    105 &    106 &    106         \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM}
&    756 &    786 &    782 &    798 &    798         \\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&     84 &     85 &     86 &     86 &     86         \\\cline{1-7} \multirow{3}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  0.033 &  0.033 &  0.033 &  0.034 &  0.034       \\\cline{1-7} \multirow{3}*{Residual} & \multirow{1}*{SCP$_{\rm ls}$}
& -1.28e-09 & -1.40e-09 & -9.95e-10 & -1.22e-09 & -1.56e-09        \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM}
& -7.56e-10 & -2.44e-10 & -1.05e-10 & -1.68e-11 & 1.80e-11        \\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
...
\begin{table}[h]
{\color{black}
\caption{Computational results for problem \eqref{CompSen1-1} $\epsilon =10^{-6}$}\label{table1}
\begin{center}
{\footnotesize
\begin{tabular}{|c|c|c|c|c|c|c|}\hline
\phantom{\diagbox{Date}{$i$}} & \multicolumn{1}{|c|}{Method} & \multicolumn{1}{|c|}{$i = 2$} & \multicolumn{1}{c|}{ $i = 4$ }
...
\begin{table}[h]
{\color{black}
\caption{Computational results for problem \eqref{CompSen1-2} with $\varepsilon = 10^{-8}$ }\label{table2}
\begin{center}
{\footnotesize
\begin{tabular}{|c|c|c|c|c|c|c|}\hline
\phantom{\diagbox{Date}{$i$}} & \multicolumn{1}{|c|}{Method} & \multicolumn{1}{|c|}{$i = 2$} & \multicolumn{1}{c|}{ $i = 4$ }
...
\\
\cline{1-7}\multirow{6}*{CPU time} & \multirow{1}*{$t_{\rm QR}$}
&  0.565 &  3.619 & 12.766 & 28.750 & 50.948       \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{A^\dagger b}$}
&  0.006 &  0.026 &  0.059 &  0.099 &  0.149      \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{$t_{\|A\|}$}
&  0.469 &  1.366 &  4.660 &  9.708 & 17.808      \\ \cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
&  2.054 & 10.373 & 13.455 & 73.061 & 47.771        \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM}
&  4.029 & 16.103 & 37.701 & 67.083 & 109.356         \\ \cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm e}}$}
&  0.784 &  2.887 &  6.785 & 11.962 & 19.313      \\ \cline{1-7} \multirow{3}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
&    189 &    314 &    177 &    578 &    247      \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM}
&    837 &    839 &    839 &    861 &    879      \\ \cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm e}}$}
&    155 &    150 &    150 &    152 &    156      \\ \cline{1-7} \multirow{3}*{RecErr} & \multirow{1}*{SCP$_{\rm ls}$}
...
& 1.09e-11 & 9.74e-12 & 9.51e-12 & 9.46e-12 & 9.26e-12       \\ \cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm e}}$}
